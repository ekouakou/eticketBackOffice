...
const AddBannerForm = () => {
  ...
  const [formData, setFormData] = useState({
    STR_BANNAME: '', DT_BANBEGIN: '',STR_BANDESCRIPTION: '',STR_BANPATH: null,LG_AGEREQUESTID: userData?.LG_AGEID || 1, 
    BOOL_BANEVENT:1,  DT_BANEND: '',
    LG_AGEID: userData?.LG_AGEID || 1, STR_EVESTATUTFREE: 1,
  });
  ...
  const resetForm = () => {
    setFormData({
      ...
      LG_AGEREQUESTID: userData?.LG_AGEID || 1, LG_AGEID: userData?.LG_AGEID || 1,
