...
const ListeUtilisateur = () => {
          ...
          render: (value, item) => (
            <div className="d-flex align-items-center">
              ...
              <div className="d-flex justify-content-start flex-column">
                <a href={item.STR_UTIFIRSTLASTNAME} className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">
                  {value}
                </a>
                <span className="text-gray-500 fw-semibold d-block fs-7">{item.LG_PROID}</span>
              </div>
            </div>
          ),
        },
        ...
        //   title: 'Agence / Profil',
          ...
          render: (value, item) => (
            <div className="">
              ...
              <div className="d-flex justify-content-start flex-column">
                <a href={item.LG_AGEID} className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">
                  {value}
                </a>
                <span className="text-gray-500 fw-semibold d-block fs-7">Agence</span>
              </div>
            </div>
          ),
        },
        ...
        //   title: 'Earnings',
          ...
          render: (value, item) => (
            <div className="">
              ...
              <div className="d-flex justify-content-start flex-column">
                <a href={item.STR_UTIMAIL} className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">
                  {value}
                </a>
                <span className="text-gray-500 fw-semibold d-block fs-7">Email</span>
              </div>
            </div>
          ),
        },
    ...
    const actions = [
        ...
        // },
        {
          ...
          handler: (LG_UTIID) => {
            navigate(paths.saveUtilisateurs, { state: { LG_UTIID } });  // Redirige vers la page de modification en passant l'ID
            }
        },
        {
          title: 'Supprimer',
        ...
        },
        {
          ...
          icon: 'fas fa-ban', // ou fa-check selon l'état
