...
<img className='mb-5' src="assets/images/logo/logo_dark.svg" width="300px"  alt="light logo" />


      <h1 className='mb-3'>Notre site est en construction</h1>
      <svg
        version="1.1"
        x="0px"
        y="0px"
      ...
      <p>
        C'est normal, nous sommes également enthousiastes !
      </p>
    </div>
  );
};
